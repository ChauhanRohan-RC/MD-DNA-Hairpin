...
x_f = 26          # LEFT Absorbing Boundary - Folded state extension (in Å)
x_u = 40          # RIGHT Absorbing Boundary - Unfolded state extension (in Å)
...
output_fig_file = "sp_pmf2.svg"        # (optional). Leave blank to not save figure
