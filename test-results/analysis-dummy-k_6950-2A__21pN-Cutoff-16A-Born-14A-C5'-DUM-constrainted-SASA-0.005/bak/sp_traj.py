...
x_a = 26  # LEFT Absorbing Boundary - Folded state extension (in Å)
x_b = 41  # RIGHT Absorbing Boundary - Unfolded state extension (in Å)
...
## OUTPUT ----------------------
output_data_file = "sp_traj2.csv"
output_fig_file = "sp_traj2.svg"        # (optional). Leave blank to not save figure
