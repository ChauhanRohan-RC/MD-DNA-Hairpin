...
## INPUT -----------------------
extension_pdf_file = "dist_vs_pdf-avg.dat"    # Input Extension vs Probability file i.e Extension Probability
T = 300         # Constant Temp (K)

x_f = 5.1          # LEFT Absorbing Boundary - Folded state extension (in Å)
x_u = 35        # RIGHT Absorbing Boundary - Unfolded state extension (in Å)
