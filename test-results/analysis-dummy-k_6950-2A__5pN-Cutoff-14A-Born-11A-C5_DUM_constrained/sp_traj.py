...
x_a = 5.1  # LEFT Absorbing Boundary - Folded state extension (in Å)
x_b = 35  # RIGHT Absorbing Boundary - Unfolded state extension (in Å)
...
ext_bin_size = 2  # Angstrom(s) in 1 bin
