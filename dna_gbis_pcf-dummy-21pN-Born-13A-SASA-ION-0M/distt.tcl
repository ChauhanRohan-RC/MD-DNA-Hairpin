...
set checkpoints			{ 14.988 20.02 25.68 32.48 38.458 }; 		# checkpoint 1-2 DIstances (in Å) separated by space
set checkpoint_tolerance	0.005;	# checkpoint Tolerance (in Å)
