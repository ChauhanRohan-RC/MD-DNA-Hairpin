...
WORK_DIR=/scratch/parbatib/rohan/Projects/MD/dna-hairpin/dna_gbis_eq
cd $WORK_DIR
...
$NAMD_HOME/charmrun +p$TOTAL_TASKS ++mpiexec ++nodelist $nodefile $NAMD_HOME/namd2 $WORK_DIR/dna_gbis_eq.conf > $WORK_DIR/dna_gbis_eq3.log
