...
frame_index_start = 14.5e6 / frame_step_fs  # Inclusive [-1 for no start bound]
...
## Output --------------------------------------------------------------
output_pdf_data_file = "ext_pdf-2.2.csv"
output_pdf_avg_data_file = f"ext_pdf-2.2-avg{_rolling_win_bins}.csv" if _rolling_win_bins > 0 else ""
output_fig_file = "ext_pdf-2.2.pdf"
