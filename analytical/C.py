...
COL_NAME_PDF = "PDF"  # Probability Density Function (PDF)
COL_NAME_PDF_AVG = "PDF_AVG"  # PDF Running Average
...
COL_NAME_TIME = "TIME"
COL_NAME_FIRST_PASS_TIME_DISTRIBUTION = "FPTD"  # First_passage Time
