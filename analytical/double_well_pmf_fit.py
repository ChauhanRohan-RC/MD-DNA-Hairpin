...
COL_NAME_PARAM = "PARAM"
COL_NAME_PARAM_VALUE = "VALUE"
COL_NAME_STD_DEV = "STD_DEV"
...
def main():
    ...
    param_df: pd.DataFrame = pd.DataFrame({
        COL_NAME_PARAM: param_names,
        COL_NAME_PARAM_VALUE: param_opt_vals,
        COL_NAME_STD_DEV: param_std_dev
    })
    ...
    if output_params_file:
        with open(output_params_file, "w") as out_p:
            ...
            out_p.write(
                f"{comment_token} INPUT data file: {data_file_name}  |  x_column: {data_x_col_name}  |  pmf_column: {data_pmf_col_name}\n")
